...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>{
    ...
    private ArrayList<id.ac.pelitabangsa.uas_muhammadasyrofalfandi.Activity.DataFilter> dataList;
    private Context context;

    //Membuat Konstruktor pada Class RecyclerViewAdapter
    RecyclerViewAdapter(ArrayList<id.ac.pelitabangsa.uas_muhammadasyrofalfandi.Activity.DataFilter> dataList){
    ...
    void setFilter(ArrayList<id.ac.pelitabangsa.uas_muhammadasyrofalfandi.Activity.DataFilter> filterList){
